...
if __name__=="__main__":
    ...
    parser.add_argument("--original_data_path", type=str, default="raw_data/hotpotqa_dev_20k.jsonl", help="model name for evaluation")
    parser.add_argument("--query_save_path", type=str, default="data/hotpotqa_dev_query_full.jsonl", help="model name for evaluation")
    parser.add_argument("--t2p_save_path", type=str, default="data/hotpotqa_dev_t2p.jsonl", help="model name for evaluation")
    parser.add_argument("--dataset_type", default="hotpotqa", choices=["2wikimultihopqa","musique","hotpotqa"],  help="model name for evaluation")
